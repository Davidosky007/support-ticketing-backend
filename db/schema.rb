...
ActiveRecord::Schema[7.1].define(version: 2025_05_12_161607) do
  ...
  create_table "ticket_assignments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "index_ticket_assignments_on_agent_id"
  ...
  add_foreign_key "ticket_assignments", "users", column: "agent_id"
